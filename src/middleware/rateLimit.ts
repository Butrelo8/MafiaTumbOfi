...
/**
 * Get client identifier from proxy headers.
 * SECURITY: Only use behind trusted reverse proxy (nginx, Cloudflare)
 * that strips client-supplied x-forwarded-for headers.
 */
